...
if __name__ == "__main__":
    ...
    filename_prefix = os.getcwd() + "\\out\\"
    tts.text_to_speech(
        prompt, say=False, save=True, file_name=filename_prefix + "text.mp3"
    )
    ...
    merge_audio_files(
        [
            filename_prefix + "sample-1.mp3",
            filename_prefix + "text.mp3",
            filename_prefix + "sample-2.mp3",
        ],
