...
class Generator:
    ...
    def __get_from_progression(
        key: str, progression: list[int], addon: int
    ) -> list[str]:
    ...
    def get_axis_progression_chords(key: str, addon: int = 0) -> list[str]:
        ...
        | I | V | vi | IV |
        """
        return Generator.__get_from_progression(
    ...
    def get_random_simple_progression_chords(
        key: str, addon: int = 0, chords_num: int = 4
    ) -> list[str]:
        """
        ...
        return Generator.__get_from_progression(
            key=key, progression=progression, addon=addon
        )
