...
class Generator:
    ...
    def get_random_simple_progression_chords(key: str, addon: int = 0, chords_num: int = 4) -> list[str]:
        """
        ...
        middle = [1, 2, 3, 4, 5, 6]
        ending = [4, 5]
        progression = [1] + [random.choice(middle) for _ in range(chords_num - 2)] + [random.choice(ending)]
        print(progression)
