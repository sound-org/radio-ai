...
def test_text_to_speech(mock_generate, mock_set_api_key, mock_voice_class):
...
def test_save_no_audio_generated(mock_save, mock_set_api_key, mock_voice_class):
    tts = TextToSpeechElevenLabs(output_dir="/path/to/output")
...
def test_save_audio_generated_and_saved(
    mock_generate, mock_save, mock_voice_class, mock_set_api_key
):
    tts = TextToSpeechElevenLabs(output_dir="/path/to/output")
...
def test_get_TTS_driver_name(mock_voice_class, mock_set_api_key):
    tts = TextToSpeechElevenLabs(output_dir="/path/to/output")
    assert tts.get_TTS_driver_name() == "elevenlabs"


def test_get_TTS_voice_name(mock_voice_class, mock_set_api_key):
    tts = TextToSpeechElevenLabs(output_dir="/path/to/output")
    print("voice")
